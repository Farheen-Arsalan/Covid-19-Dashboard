...
def run():
    ...
    link = '[©Developed by Farheen Shaukat](https://www.linkedin.com/in/farheen-shaukat-83a7b9b6/)'
...
st.write('''
    Dashboard created by [Farheen Shaukat](https://www.linkedin.com/in/farheen-shaukat-83a7b9b6/), with [Streamlit](https://www.streamlit.io).
    See the code on [GitHub](https://github.com/Farheen-Arsalan/Covid-19-Dashboard/blob/main/Dashboard.py).
